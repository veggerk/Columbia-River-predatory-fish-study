---
title: "walleye size effect as a fixed factor instead of continuous effect"
...
iso_names=c("d15N","d13C"), factors="size_grouping",fac_random=FALSE,
...
```{r walleye jags code to modify factor plots above 500mm}
...
```{r walleye jags code to modify factor plots below 500mm}
#' Process mixing model output from JAGS
#'
#' \code{output_JAGS} processes the mixing model output, prints and saves (in the
#' working directory):
